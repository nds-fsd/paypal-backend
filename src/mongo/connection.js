...
const databaseName = process.env.DATABASE_NAME || 'nuclio';
...
if(databaseURL){
	...
	if(databaseUser && databasePassword) {
		console.log(`mongodb://${databaseUser}:${databasePassword}@${databaseHost}:${databasePort}/${databaseName}?authSource=admin`);
